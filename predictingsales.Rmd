...
express_ols <- train_set_express %>% lm(sale ~ ny_snow + ny_mean_temp + ny_precip + la_mean_temp +la_precip + chi_snow + chi_mean_temp + chi_precip + hou_mean_temp + hou_precip + unemployment + expr_adj_close, data = .)
                                          
#fit glm logistic regression to train set
express_glm <- train_set_express %>% glm(sale ~ ny_snow + ny_mean_temp + ny_precip + la_mean_temp +la_precip + chi_snow + chi_mean_temp + chi_precip + hou_mean_temp + hou_precip + unemployment + expr_adj_close, data=. , family = "binomial")
...
#fit OLS regression to train set
gap_ols <- train_set_gap %>% lm(sale ~ ny_snow + ny_mean_temp + ny_precip + la_mean_temp +la_precip + chi_snow + chi_mean_temp + chi_precip + hou_mean_temp + hou_precip + unemployment + gap_adj_close, data=.)

#fit glm logistic regression to train set
gap_glm <- train_set_gap %>% glm(sale ~ ny_snow + ny_mean_temp + ny_precip + la_mean_temp +la_precip + chi_snow + chi_mean_temp + chi_precip + hou_mean_temp + hou_precip + unemployment + gap_adj_close, data=. , family = "binomial")
...
#fit OLS regression to train set
loft_ols <- train_set_loft %>% lm(sale ~ ny_snow + ny_mean_temp + ny_precip + la_mean_temp +la_precip + chi_snow + chi_mean_temp + chi_precip + hou_mean_temp + hou_precip + unemployment + loft_adj_close, data=.)

#fit glm logistic regression to train set
loft_glm <- train_set_loft %>% glm(sale ~ ny_snow + ny_mean_temp + ny_precip + la_mean_temp +la_precip + chi_snow + chi_mean_temp + chi_precip + hou_mean_temp + hou_precip + unemployment + loft_adj_close, data=. , family = "binomial")
...
#fit OLS regression to train set
jcrew_ols <- train_set_jcrew %>% lm(sale ~ ny_snow + ny_mean_temp + ny_precip + la_mean_temp +la_precip + chi_snow + chi_mean_temp + chi_precip + hou_mean_temp + hou_precip + unemployment, data=.)

#fit glm logistic regression to train set
jcrew_glm <- train_set_jcrew %>% glm(sale ~ ny_snow + ny_mean_temp + ny_precip + la_mean_temp +la_precip + chi_snow + chi_mean_temp + chi_precip + hou_mean_temp + hou_precip + unemployment, data=. , family = "binomial")
